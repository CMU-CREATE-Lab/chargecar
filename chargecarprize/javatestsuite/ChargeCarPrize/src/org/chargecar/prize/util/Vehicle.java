...
public class Vehicle {
    ...
    private final double carCrossArea; //= 1.988;// honda civic 2001 si fronta area in
    // metres sq
    private final double carDragCoeff;// = 0.31;// honda civic 2006 sedan
    private final double rollingResCoeff;// = 0.015; // #rolling resistance coef
