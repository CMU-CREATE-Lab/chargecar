...
public final class DriveHistoryMenuItemAction extends RepeatingActionCharacterDisplayMenuItemAction {
    ...
    private List<Boolean> printHeadings = Arrays.asList(true, true, true, true, true, true, true, true);
    ...
    public void performAction8() {
        ...
        if (printHeadings.get(7)) {
            printHeadings.set(7, false);
