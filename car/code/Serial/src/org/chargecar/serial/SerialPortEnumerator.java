...
public final class SerialPortEnumerator
   ...
   public static SortedSet<String> getSerialPorts()
      {
      LOG.trace("SerialPortEnumerator.getSerialPorts()");
   ...
   public static SortedSet<String> getAvailableSerialPorts()
      {
      LOG.trace("SerialPortEnumerator.getAvailableSerialPorts()");
   ...
   public static CommPortIdentifier getSerialPortIdentifer(final String serialPortName)
      ...
      try
         ...
         {
         LOG.error("NoSuchPortException while trying to get the CommPortIdentifier for port [" + serialPortName + "]", e);
         }
   ...
   private static SortedMap<String, CommPortIdentifier> getSerialPortsAsMap()
      {
      LOG.trace("SerialPortEnumerator.getSerialPortsAsMap()");
      ...
      if (LOG.isTraceEnabled())
         {
         LOG.trace("SerialPortEnumerator.getSerialPortsAsMap(): returning [" + portMap.size() + "] ports");
         }
      return portMap;
      }
   ...
   private static SortedMap<String, CommPortIdentifier> getAvailableSerialPortsAsMap()
      {
      LOG.trace("SerialPortEnumerator.getAvailableSerialPortsAsMap()");
      ...
      if (LOG.isTraceEnabled())
         {
         LOG.trace("SerialPortEnumerator.getAvailableSerialPortsAsMap(): returning [" + availablePorts.size() + "] ports");
         }
