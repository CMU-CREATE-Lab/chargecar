...
class FakeGPS extends FakeStreamingSerialDevice
   ...
   private static final String DATA = "$GPRMC,190017,A,4026.6896,N,07956.8459,W,0.0,159.5,200710,9.2,W,A*1E\r\n" +
                                      ...
                                      "$HCHDG,49.1,,,9.2,W*0C\r\n" +
                                      "$GPRTE,1,1,c,*37\r\n" +
                                      "$GPGSV,3,1,12,29,59,017,,18,52,269,,15,52,089,26,25,49,216,*73\r\n" +
                                      "$GPGSV,3,2,12,10,37,015,,21,25,332,,22,25,240,,12,25,169,*77\r\n" +
                                      "$GPGSV,3,3,12,26,21,057,,09,13,147,,27,08,128,,30,05,309,*7C\r\n" +
                                      "$GPRMC,164039.922,V,,,,,,,180211,,,N*46\r\n" +
                                      "$GPGGA,164040.922,,,,,0,00,,,M,0.0,M,,0000*58\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164040.922,V,,,,,,,180211,,,N*48\r\n" +
                                      "$GPGGA,164041.922,,,,,0,00,,,M,0.0,M,,0000*59\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164041.922,V,,,,,,,180211,,,N*49\r\n" +
                                      "$GPGGA,164042.922,,,,,0,00,,,M,0.0,M,,0000*5A\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164042.922,V,,,,,,,180211,,,N*4A\r\n" +
                                      "$GPGGA,164043.922,,,,,0,00,,,M,0.0,M,,0000*5B\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164043.922,V,,,,,,,180211,,,N*4B\r\n" +
                                      "$GPGGA,164044.922,,,,,0,00,,,M,0.0,M,,0000*5C\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPGSV,3,1,12,29,59,017,,18,52,269,,15,52,089,17,25,49,216,*71\r\n" +
                                      "$GPGSV,3,2,12,10,37,015,,21,25,332,,22,25,240,,12,25,169,*77\r\n" +
                                      "$GPGSV,3,3,12,26,21,057,,09,13,147,,27,08,128,,30,05,309,*7C\r\n" +
                                      "$GPRMC,164044.922,V,,,,,,,180211,,,N*4C\r\n" +
                                      "$GPGGA,164045.922,,,,,0,00,,,M,0.0,M,,0000*5D\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164045.922,V,,,,,,,180211,,,N*4D\r\n" +
                                      "$GPGGA,164046.930,,,,,0,00,,,M,0.0,M,,0000*5D\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164046.930,V,,,,,,,180211,,,N*4D\r\n" +
                                      "$GPGGA,164047.925,,,,,0,00,,,M,0.0,M,,0000*58\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164047.925,V,,,,,,,180211,,,N*48\r\n" +
                                      "$GPGGA,164048.925,,,,,0,00,,,M,0.0,M,,0000*57\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164048.925,V,,,,,,,180211,,,N*47\r\n" +
                                      "$GPGGA,164049.925,,,,,0,00,,,M,0.0,M,,0000*56\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPGSV,3,1,12,29,59,017,,18,52,269,,15,52,089,19,25,49,216,*7F\r\n" +
                                      "$GPGSV,3,2,12,10,37,015,,21,25,332,,22,25,240,,12,25,169,*77\r\n" +
                                      "$GPGSV,3,3,12,26,21,057,,09,13,147,,27,08,128,,30,05,309,*7C\r\n" +
                                      "$GPRMC,164049.925,V,,,,,,,180211,,,N*46\r\n" +
                                      "$GPGGA,164050.925,,,,,0,00,,,M,0.0,M,,0000*5E\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164050.925,V,,,,,,,180211,,,N*4E\r\n" +
                                      "$GPGGA,164051.925,,,,,0,00,,,M,0.0,M,,0000*5F\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164051.925,V,,,,,,,180211,,,N*4F\r\n" +
                                      "$GPGGA,164052.923,,,,,0,00,,,M,0.0,M,,0000*5A\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164052.923,V,,,,,,,180211,,,N*4A\r\n" +
                                      "$GPGGA,164053.923,,,,,0,00,,,M,0.0,M,,0000*5B\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n" +
                                      "$GPRMC,164053.923,V,,,,,,,180211,,,N*4B\r\n" +
                                      "$GPGGA,164054.923,,,,,0,00,,,M,0.0,M,,0000*5C\r\n" +
                                      "$GPGSA,A,1,,,,,,,,,,,,,,,*1E\r\n";
   }
